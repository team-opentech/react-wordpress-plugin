                ...
                if (isset($data['response'])) {
                    ...
                    $wpdb->replace(
                        ...
                        [
                            ...
                            'dep_time_ts' => !empty($flightData['dep_estimated']) ? $flightData['dep_estimated'] : $flightData['dep_time'],
                            'dep_delayed' => $flightData['dep_delayed'],
                            'arr_iata' => $flightData['arr_iata'],
                            'arr_icao' => $flightData['arr_icao'],
                            'arr_gate' => $flightData['arr_gate'],
                            'arr_time_ts' => !empty($flightData['arr_estimated']) ? $flightData['arr_estimated'] : $flightData['arr_time'],
